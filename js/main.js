...
*/	
	$("#quoteForm").validator().on("submit", function (event) {
		if (event.isDefaultPrevented()) {
			...
			if (filter.test($("#quotePhone").val())) {
				...
				submitQuoteMSG(false, "Please enter a valid phone number");
				return false;
			}
	...
	function quoteFormSuccess(){
		$("#quoteForm")[0].reset();
		submitQuoteMSG(true, "Your Quote Request Has Been Submitted Successfully!")
	}
...
*/	
	$("#contactForm").validator().on("submit", function (event) {
		if (event.isDefaultPrevented()) {
			...
			if (filter.test($("#phone").val())) {
				...
				submitContactMSG(false, "Please enter a valid phone number");
				return false;
			}
	...
	function contactFormSuccess(){
		$("#contactForm")[0].reset();
		submitContactMSG(true, "Your Message Has Been Submitted Successfully!")
	}
